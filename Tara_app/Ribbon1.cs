...
namespace Tara_app
{
    public partial class AI_Spark
    {
        ...
        public void Apply_formats()
        {
            ...
            Excel.Range uw_range = tara_sheet.UsedRange.Columns["H:J", Type.Missing];
            ...
            Excel.Range group_range_comp = tara_sheet.Range["D:G"];
            group_range_comp.Columns.Group();
            group_range_comp.Columns.OutlineLevel = 2;
            Excel.Range group_range_admin = tara_sheet.Range["K:P"];
            group_range_admin.Columns.Group();
            group_range_admin.Columns.OutlineLevel = 4;
            Excel.Range group_range_pct = tara_sheet.Range["AB:AJ"];
